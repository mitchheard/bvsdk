		...
		ugc : {
			...
			question : {
				...
				initQuestionAnswerWidget : function () {
					console.log("initQuestionAnswerWidget");
					bvsdk.models.ugc.question.getUGC (bvConfigSDK["productId"], bvsdk.models.targets["ugc"]["question"]["container-widget"], function(content, modelLocalDefaultSettings) {
						...
						// TODO: does this work?
						// bvsdk.controllers.magpie.trackPageView (null, bvsdk.models.magpie.pageTrackContent["AskAndAnswer"]);
				...
				loadQuestionAnswerWidget : function (content, options) {
					console.log("loadQuestionAnswerWidget");
					...
					// set content'
					console.log("now we are here in loadQuestionAnswerWidget0", content);
					var bvContent = {};
					...
					// 		/***** magpie start *****/
					// 		// TODO: is AskAndAnswer correct for magpie call?
					//   		//bvsdk.models.magpie.pageTrackContent["AskAndAnswer"]["categoryId"] = content["Includes"]["Products"][settings["productId"]]["CategoryId"];
					//   		//bvsdk.models.magpie.pageTrackContent["AskAndAnswer"]["brand"] = content["Includes"]["Products"][settings["productId"]]["Brand"]["Name"];
					// 		/***** magpie end *****/
					// 	}
					// }
					var ugcToLoad = content["Results"]; // questions
					console.log("now we are here in loadQuestionAnswerWidget1");
					// set container & template
					var $container = $bvsdk(settings["parentContainer"]).find(settings["targetContainer"]).andSelf().filter(settings["targetContainer"]);
					
					console.log("now we are here in loadQuestionAnswerWidget1.5");
					console.log(bvContent);
					console.log(settings["viewContainer"]);
					var $template = bvsdk.controllers.general.returnTemplate (bvContent, settings["viewContainer"]);
					console.log("now we are here in loadQuestionAnswerWidget1.8");
					// add widget template
					$container.html($template);

					/***** headers *****/
					console.log("now we are here in loadQuestionAnswerWidget2");
					...
					if (ugcToLoad != "" && ugcToLoad != null && ugcToLoad != undefined && !$bvsdk.isEmptyObject(ugcToLoad)) {
						console.log("i made it to the if",ugcToLoad.length);
						...
						$bvsdk.each (ugcToLoad, function(key) {
							bvsdk.controllers.ugc.question.loadIndividualUGC (ugcToLoad[key], {
								...
								"productId":settings["productId"],
								"magpie":{
									//"categoryId":bvsdk.models.magpie.pageTrackContent["AskAndAnswer"]["categoryId"],
									"rootCategoryId":null,
									"brand":bvsdk.models.magpie.pageTrackContent["AskAndAnswer"]["brand"],
								}
							});
						});
							console.log("now we are here in loadQuestionAnswerWidget3");
						// pagination
				...
				loadIndividualUGC : function (content, options) {
					...
					if (typeof content["TotalAnswerCount"] != undefined) {
					...
					// TODO: [mheard] commenting out to fix a "top" error - fix later
					/***** magpie start - place all content loading BEFORE this *****/
				...
				loadPrimarySummary : function (content, options) {
					console.log("loadPrimarySummary", content);
					var settings = $bvsdk.extend(true, {
					...
					if (content["Includes"]["Products"]) {
						if (content["Includes"]["Products"][settings["productId"]]) {
							ugcStatisticsToLoad = content["Includes"]["Products"][settings["productId"]]['FilteredQAStatistics'] || content["Includes"]["Products"][settings["productId"]]['QAStatistics']; // review stats
						}
					}
				...
				loadPrimarySummaryNoContent : function (content, options) {
					console.log("loadPrimarySummaryNoContent");
					var settings = $bvsdk.extend(true, {
						"parentContainer":"body", // template must be defined in call
						"targetContainer":bvsdk.models.targets["ugc"]["question"]["container-summary-primary"],
						"viewContainer":bvsdk.models.templates["ugc"]["question"]["container-summary-primary-nocontent"],
						"productId":"",
					}, options);
					// set content
					var bvContent = {};
			...
			answer : {
				...
				loadAnswerWidget : function (content, options) {
					console.log("loadAnswerWidget");
					var settings = $bvsdk.extend(true, {
						"parentContainer":"", // container must be defined in call
						"targetContainer":bvsdk.models.targets["ugc"]["answer"]["container-widget"],
						"viewContainer":bvsdk.models.templates["ugc"]["answer"]["container-widget"],
						"loadOrder":"",
						"productId":"",
						"modelLocalDefaultSettings":"",
					}, options);
				...
				loadIndividualReviewComment : function (content, options) {
					console.log("loadIndividualReviewComment");
					var settings = $bvsdk.extend(true, {
						"parentContainer":"", // container must be defined in call
			...
			review : {
				...
				initRatingReviewWidget : function () {
					console.log("initRatingReviewWidget");
				...
				loadRatingReviewWidget : function (content, options) {
					console.log("loadRatingReviewWidget");
					var settings = $bvsdk.extend(true, {
						"parentContainer" :"body", // container must be defined in call
				...
				loadPrimarySummary : function (content, options) {
					console.log("loadPrimarySummary");
					var settings = $bvsdk.extend(true, {
						"parentContainer":"body", // template must be defined in call
				...
				loadQuickTakeNoContent : function (content, options) {
					console.log("loadQuickTakeNoContent");
					var settings = $bvsdk.extend(true, {
						"parentContainer":"body", // template must be defined in call
						"targetContainer":bvsdk.models.targets["ugc"]["review"]["container-quicktake"],
				...
				initFeaturedUGCWidget : function () {
					console.log("initFeaturedUGCWidget");
				...
				loadFeaturedUGCWidget : function (content, options) {
					console.log("loadFeaturedUGCWidget");
					var settings = $bvsdk.extend(true, {
						"parentContainer" :"body", // container must be defined in call
				...
				initVersusUGCWidget : function () {
					console.log("initVersusUGCWidget");
				...
				loadHelpfulHighUGCWidget : function (content, options) {
					console.log("loadHelpfulHighUGCWidget");
					var settings = $bvsdk.extend(true, {
						"parentContainer" :"body", // container must be defined in call
				...
				loadHelpfulLowUGCWidget : function (content, options) {
					console.log("loadHelpfulLowUGCWidget");
					var settings = $bvsdk.extend(true, {
						"parentContainer" :"body", // container must be defined in call
				...
				loadTagCloudWidget : function (content, options) {
					console.log("loadTagCloudWidget");
					var settings = $bvsdk.extend(true, {
						"parentContainer" :"body", // container must be defined in call
			...
			reviewcomment : {
				...
				loadReviewCommentsWidget : function (content, options) {
					console.log("loadReviewCommentsWidget");
					var settings = $bvsdk.extend(true, {
						"parentContainer":"", // container must be defined in call
